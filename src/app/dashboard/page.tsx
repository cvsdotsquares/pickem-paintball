...
export default function Dashboard() {
  return (
    <section className="absolute flex h-screen w-full overflow-hidden">
      <div className="relative rounded-2xl pr-4 flex z-0 left-0 md:flex-row flex-col justify-start w-[97vw]">
        <div className="relative   flex justify-center my-auto w-[60vw] h-full">
          ...
          <div className="relative bg-black/40 p-16 flex  items-stretch justify-center w-full h-full">
            <UserProfile />
          </div>
        </div>
