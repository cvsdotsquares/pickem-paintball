              ...
              users.map((user, index) => {
                ...
                return (
                  <Fragment key={user.id}>
                    ...
                    >
                      <td className={cn("px-3 py-2.5 text-sm sticky left-0 z-10 bg-inherit whitespace-nowrap align-middle shadow-[2px_0_0_0_rgb(209_213_219_/_0.35)] dark:shadow-[2px_0_0_0_rgb(75_85_99_/_0.35)]", currentUserId === user.id && "[box-shadow:inset_6px_0_0_0_#00f976] sm:[box-shadow:inset_4px_0_0_0_#00f976]")}>
