            ...
            <table className="w-full text-sm text-white">
              <thead>
                <tr className="border-b-2 border-gray-700">
                  <th className="text-left py-4 px-3 font-bold text-lg">Rank</th>
                  <th className="text-left py-4 px-3 font-bold text-lg">Player</th>
                  <th className="text-left py-4 px-3 font-bold text-lg">Team</th>
                  <th className="text-center py-4 px-3 font-bold text-lg">Total Kills</th>
