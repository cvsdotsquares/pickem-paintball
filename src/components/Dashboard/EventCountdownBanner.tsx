  ...
  if (variant === "dashboard") {
    ...
    const blackBarClass = cn(
      ...
      mobileBlackBarFullBleed
        ? // Black strip edge-to-edge at all breakpoints; horizontal inset lives on the inner wrapper (white pill).
          "relative ml-[calc(50%-50vw)] w-screen max-w-[100vw] pl-0 pr-0"
