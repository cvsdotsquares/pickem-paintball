...
const TableData = () => {
    ...
    return (
        <div className="bg-slate-100 p-4 rounded-lg md:w-auto w-screen overflow-hidden">
            <div className="mb-5 flex flex-col gap-5 md:flex-row items-center md:justify-between">
                <h5 className="text-lg font-semibold text-slate-600">Players List</h5>
                <div className="flex">
                    <input type="text" className="form-input text-white placeholder-slate-300 bg-slate-600 border-black border rounded-md p-2 w-auto" placeholder="Search..." value={search} onChange={(e) => setSearch(e.target.value)} />
                </div>
            </div>
