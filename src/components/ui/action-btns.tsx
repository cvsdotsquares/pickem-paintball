...
const ActionButtons = () => {
  return (
    <div className="flex flex-col md:flex-row gap-2 md:justify-evenly justify-center items-center px-3 mt-6 w-full text-xs whitespace-nowrap text-center m-auto font-bold leading-none text-white ">
      <Link
