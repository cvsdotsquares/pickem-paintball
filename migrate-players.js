...
// Event mapping with seasons
const eventSeasonMapping = {
  // 2025 Season Events
  'atlantic_city_2025': { season: '2025', year: '2025' },
  'lonestar_open_2025': { season: '2025', year: '2025' },
  'midwest_open_2025': { season: '2025', year: '2025' },
  'tampa_bay_2025': { season: '2025', year: '2025' },
  'world_cup_2025': { season: '2025', year: '2025' },
  
  // 2024 Season Events  
  'windy_city_open_2024': { season: '2024', year: '2024' },
  'worldcup_2024': { season: '2024', year: '2024' }
};
      ...
      for (let i = 0; i < players.length; i += batchSize) {
        ...
        batchPlayers.forEach((playerDoc) => {
          ...
          const newPlayerData = {
            ...
            year: eventInfo.year,
            eventStatus: 'completed', // Default for existing events
...
const calculateEventRankings = async () => {
    ...
    for (const [eventId, eventInfo] of Object.entries(eventSeasonMapping)) {
      ...
      for (let i = 0; i < sortedPlayers.length; i += batchSize) {
        ...
        batchPlayers.forEach((player, index) => {
          const globalRank = i + index + 1; // Global rank across all batches
